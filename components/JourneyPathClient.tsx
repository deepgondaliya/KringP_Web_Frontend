...
import { UserPlus, Link2, Eye, TrendingUp, DollarSign, Users } from "lucide-react";
        ...
        {steps.map((_, index) => {
          ...
          return (
            <circle
              ...
              cy={yPosition}
              r={isVisible ? 12 : 8}
              fill={isVisible ? "hsl(var(--accent))" : "hsl(var(--muted))"}
              ...
              >
                <div
                  className={`p-6 md:p-8 rounded-2xl bg-card/80 backdrop-blur-sm border transition-all duration-500 ${
                    isVisible
                      ? "border-accent/50 shadow-[0_0_30px_-5px_hsl(var(--accent)/0.3)]"
                      : "border-border"
                  }`}
                >
                  <div className="flex items-center gap-4 mb-4">
                    <div
                      className={`w-14 h-14 rounded-xl flex items-center justify-center transition-all duration-500 ${
                        isVisible
                          ? "bg-gradient-purple-orange shadow-lg"
                          : "bg-muted"
                      }`}
                    >
                      <IconComponent
