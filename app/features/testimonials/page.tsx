...
export default function Testimonials() {
  ...
  return (
    <div className="min-h-screen bg-background relative">
      ...
      {/* Stats Section */}
      <section className="-mt-28 py-8 border-y border-border bg-white/95 backdrop-blur-sm relative z-10">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {testimonials.map((testimonial, index) => (
              <div
                ...
                className={`
                   p-8 rounded-3xl border transition-all duration-700 bg-white/95 backdrop-blur-sm relative z-10
              ...
              >
                {/* Quote icon */}
                <Quote className={`
                  absolute top-6 right-6 w-12 h-12 opacity-10
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <button className="px-8 py-4 bg-gradient-purple-orange text-primary-foreground font-semibold rounded-xl hover:opacity-90 transition-opacity">
                I'm a Creator
              </button>
              <button className="px-8 py-4 bg-card border border-primary text-primary font-semibold rounded-xl hover:bg-primary/10 transition-colors">
                I'm a Business
              </button>
            </div>
          </div>
